...
function tabUI() {
    ...
    var tabs_first_active = $(
        ".vacation__list-title.vacation__list-title-active"
    );
    console.log(tabs);
    ...
    tabs.forEach((tab, index) => {
        tab.onclick = function () {
            ...
            $(
                ".vacation__list-desc.vacation__list-desc-active"
            ).classList.remove("vacation__list-desc-active");
            pane.classList.add("vacation__list-desc-active");

            $(
                ".vacation__list-title.vacation__list-title-active"
            ).classList.remove("vacation__list-title-active");
